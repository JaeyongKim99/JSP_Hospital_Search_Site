  ...
  <div class="container">
  	<div class="row">
	  	<div class="py-3 col-md-3">
	   	    <button type="button" class="btn btn-light" style="border: 2px solid black;"><i class="fa-solid fa-plus"></i></button>
	    	<button type="button" class="btn btn-light" style="border: 2px solid black;"><i class="fa-solid fa-minus"></i></button>
	  	</div>
	</div>
  </div>
